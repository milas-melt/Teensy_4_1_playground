...
const int BUTTON_ARDUINO_PIN[N_BUTTONS] = {27,26,25}; //* pins of each button connected straight to the Arduino
...
const int POT_ARDUINO_PIN[N_POTS] = {A14, A15}; //* pins of each pot connected straight to the Arduino
